...
test('(3 pts) (scenario) expected object', () => {
  ...
  let serializedObject = '{"type":"number","value":"7"}'; /* Add here the expected serialized string by using util.serialize */
...
/* Come up with an object that uses all valid (serializable)
  ...
  let object = {
      ...
      errorType: new Error("an error"),
      dateType: new Date(),
      arrayType: [1, 2, 3, 4],
      funType: (a, b) => {return a + b;}
  };
...
/* Come up with a string that is not a valid serialized object. */
  ...
  let malformedSerializedString = "hello";
